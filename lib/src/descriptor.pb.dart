...
class FileDescriptorSet extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FileDescriptorSet')
    ..m(1, 'file', FileDescriptorProto.create,
        FileDescriptorProto.createRepeated);
...
class FileDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FileDescriptorProto')
    ...
    ..m(4, 'messageType', DescriptorProto.create,
        DescriptorProto.createRepeated)
    ..m(5, 'enumType', EnumDescriptorProto.create,
        EnumDescriptorProto.createRepeated)
    ..m(6, 'service', ServiceDescriptorProto.create,
        ServiceDescriptorProto.createRepeated)
    ..m(7, 'extension', FieldDescriptorProto.create,
        FieldDescriptorProto.createRepeated)
    ..a(8, 'options', GeneratedMessage.OM, FileOptions.create,
        FileOptions.create)
    ..a(9, 'sourceCodeInfo', GeneratedMessage.OM, SourceCodeInfo.create,
  ...
  void set options(FileOptions v) {
    setField(8, v);
  }
  ...
  void set sourceCodeInfo(SourceCodeInfo v) {
    setField(9, v);
  }
...
class DescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DescriptorProto')
    ..a(1, 'name', GeneratedMessage.OS)
    ..m(2, 'field', FieldDescriptorProto.create,
        FieldDescriptorProto.createRepeated)
    ..m(6, 'extension', FieldDescriptorProto.create,
        FieldDescriptorProto.createRepeated)
    ..m(3, 'nestedType', DescriptorProto.create, DescriptorProto.createRepeated)
    ..m(4, 'enumType', EnumDescriptorProto.create,
        EnumDescriptorProto.createRepeated)
    ..m(5, 'extensionRange', DescriptorProto_ExtensionRange.create,
        DescriptorProto_ExtensionRange.createRepeated)
    ..a(7, 'options', GeneratedMessage.OM, MessageOptions.create,
  ...
  void set options(MessageOptions v) {
    setField(7, v);
  }
...
class FieldDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FieldDescriptorProto')
    ...
    ..e(4, 'label', GeneratedMessage.OE,
        FieldDescriptorProto_Label.LABEL_OPTIONAL,
        (var v) => FieldDescriptorProto_Label.valueOf(v))
    ..e(5, 'type', GeneratedMessage.OE, FieldDescriptorProto_Type.TYPE_DOUBLE,
    ...
    ..a(8, 'options', GeneratedMessage.OM, FieldOptions.create,
        FieldOptions.create);
  ...
  void set label(FieldDescriptorProto_Label v) {
    setField(4, v);
  }
  ...
  void set type(FieldDescriptorProto_Type v) {
    setField(5, v);
  }
  ...
  void set options(FieldOptions v) {
    setField(8, v);
  }
  bool hasOptions() => hasField(8);
  void clearOptions() => clearField(8);
...
class EnumDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('EnumDescriptorProto')
    ..a(1, 'name', GeneratedMessage.OS)
    ..m(2, 'value', EnumValueDescriptorProto.create,
        EnumValueDescriptorProto.createRepeated)
    ..a(3, 'options', GeneratedMessage.OM, EnumOptions.create,
        EnumOptions.create);
  ...
  void set options(EnumOptions v) {
    setField(3, v);
  }
...
class EnumValueDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('EnumValueDescriptorProto')
    ...
    ..a(3, 'options', GeneratedMessage.OM, EnumValueOptions.create,
        EnumValueOptions.create);
  ...
  void set options(EnumValueOptions v) {
    setField(3, v);
  }
  bool hasOptions() => hasField(3);
  void clearOptions() => clearField(3);
...
class ServiceDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ServiceDescriptorProto')
    ..a(1, 'name', GeneratedMessage.OS)
    ..m(2, 'method', MethodDescriptorProto.create,
        MethodDescriptorProto.createRepeated)
    ..m(4, 'stream', StreamDescriptorProto.create,
        StreamDescriptorProto.createRepeated)
    ..a(3, 'options', GeneratedMessage.OM, ServiceOptions.create,
  ...
  void set options(ServiceOptions v) {
    setField(3, v);
  }
  bool hasOptions() => hasField(3);
  void clearOptions() => clearField(3);
...
class MethodDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MethodDescriptorProto')
    ...
    ..a(4, 'options', GeneratedMessage.OM, MethodOptions.create,
  ...
  void set options(MethodOptions v) {
    setField(4, v);
  }
...
class StreamDescriptorProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StreamDescriptorProto')
    ...
    ..a(4, 'options', GeneratedMessage.OM, StreamOptions.create,
        StreamOptions.create);

  StreamDescriptorProto() : super();
  StreamDescriptorProto.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  StreamDescriptorProto.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  StreamDescriptorProto clone() =>
      new StreamDescriptorProto()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static StreamDescriptorProto create() => new StreamDescriptorProto();
  static PbList<StreamDescriptorProto> createRepeated() =>
      new PbList<StreamDescriptorProto>();
  ...
  void set clientMessageType(String v) {
    setField(2, v);
  }
  ...
  void set serverMessageType(String v) {
    setField(3, v);
  }
  ...
  void set options(StreamOptions v) {
    setField(4, v);
  }
  bool hasOptions() => hasField(4);
  void clearOptions() => clearField(4);
...
class FileOptions_OptimizeMode extends ProtobufEnum {
  ...
  static const List<FileOptions_OptimizeMode> values =
      const <FileOptions_OptimizeMode>[SPEED, CODE_SIZE, LITE_RUNTIME,];
...
class FileOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FileOptions')
    ...
    ..e(9, 'optimizeFor', GeneratedMessage.OE, FileOptions_OptimizeMode.SPEED,
    ...
    ..m(999, 'uninterpretedOption', UninterpretedOption.create,
        UninterpretedOption.createRepeated)
    ..hasExtensions = true;
  ...
  void set javaOuterClassname(String v) {
    setField(8, v);
  }
  ...
  void set javaMultipleFiles(bool v) {
    setField(10, v);
  }
  ...
  void set javaGenerateEqualsAndHash(bool v) {
    setField(20, v);
  }
  ...
  void set optimizeFor(FileOptions_OptimizeMode v) {
    setField(9, v);
  }
  ...
  void set ccGenericServices(bool v) {
    setField(16, v);
  }
  ...
  void set javaGenericServices(bool v) {
    setField(17, v);
  }
  ...
  void set pyGenericServices(bool v) {
    setField(18, v);
  }
...
class MessageOptions extends GeneratedMessage {
  ...
  void set messageSetWireFormat(bool v) {
    setField(1, v);
  }
  ...
  void set noStandardDescriptorAccessor(bool v) {
    setField(2, v);
  }
...
class FieldOptions_CType extends ProtobufEnum {
  ...
  static const List<FieldOptions_CType> values =
      const <FieldOptions_CType>[STRING,];
...
class FieldOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FieldOptions')
    ..e(1, 'ctype', GeneratedMessage.OE, FieldOptions_CType.STRING,
        (var v) => FieldOptions_CType.valueOf(v))
  ...
  void set ctype(FieldOptions_CType v) {
    setField(1, v);
  }
  ...
  void set experimentalMapKey(String v) {
    setField(9, v);
  }
...
class StreamOptions extends GeneratedMessage {
  ...
  StreamOptions() : super();
  StreamOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  StreamOptions.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class UninterpretedOption extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UninterpretedOption')
    ..m(2, 'name', UninterpretedOption_NamePart.create,
        UninterpretedOption_NamePart.createRepeated)
  ...
  void set identifierValue(String v) {
    setField(3, v);
  }
  ...
  void set positiveIntValue(Int64 v) {
    setField(4, v);
  }
  ...
  void set negativeIntValue(Int64 v) {
    setField(5, v);
  }
  ...
  void set stringValue(List<int> v) {
    setField(7, v);
  }
  ...
  void set aggregateValue(String v) {
    setField(8, v);
  }
...
class SourceCodeInfo extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SourceCodeInfo')
    ..m(1, 'location', SourceCodeInfo_Location.create,
        SourceCodeInfo_Location.createRepeated)
    ..hasRequiredFields = false;
